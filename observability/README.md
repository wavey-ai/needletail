...
a media completion gap above 250 ms. Mission Control uses the runtime transition
time for the event timeline. It uses the snapshot time only when an older runtime
omits that field.
