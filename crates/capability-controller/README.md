...
It re-evaluates the P01 identity authorization view, deterministically admits a
current P00 route, signs the frozen compact Ed25519 capability contract, and
creates proof-bound one-use browser exchanges.
